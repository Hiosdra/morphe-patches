/*
 * The permission, intent-action and content-authority lists below are copied
 * verbatim from Morphe's shared GmsCore support patch (GPLv3):
 * https://github.com/MorpheApp/morphe-patches
 *   patches/src/main/kotlin/app/morphe/patches/shared/misc/gms/GmsCoreSupportPatch.kt
 * which is itself a hard fork of ReVanced's GmsCore support. These lists are the
 * correctness-bearing data of the redirect: every GMS identifier the app may
 * reference at runtime, rewritten from the "com.google" vendor to the microG one.
 */
package io.github.hiosdra.patches

/**
 * The GmsCore permissions, intent actions and content provider authorities that
 * must be redirected from Google Play Services to the microG package.
 */
internal object MovieParadiseGmsConstants {
